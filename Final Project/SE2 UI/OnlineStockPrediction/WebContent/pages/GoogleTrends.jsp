...
<body>
                    ...
                    <div class="col-lg-12">
                        <h3 class="page-header"> Google Trends </h3>
  							...
  							<div class="form-group">
	                              ...
	                              </select><br><button onclick="getGoogleTrends()" class="btn btn-success">Get Google Trend</button><br>
	                          ...
	                          <iframe id="googleTrendsiFrame" 
	                           style="border:1px solid #ccc; padding:10px;" width="900px" height="500px" >
    ...
    function getGoogleTrends(){
		...
		var url = "http://www.google.com/trends/fetchComponent?hl=en-US&q=" 
	    		+ selectedSymbols 
	    		+ "&cid=TIMESERIES_GRAPH_0&export=5&w=900&h=500";
	    		
	    document.getElementById('googleTrendsiFrame').src = url;
